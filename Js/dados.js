const dados = [
    {
      ...
      descricao: 'Jhulia Rayssa Mendes Leal (Imperatriz, 4 de janeiro de 2008) é uma skatista brasileira, vice-campeã olímpica nos Jogos Olímpicos de Verão de 2020 em Tóquio e Medalha de Brone nas Olímpiadas de Paris 2024, sendo a mais jovem medalhista olímpica brasileira.',
      tags:'nova sls olimpiadas olimpica ',
    },
    {
      nome: 'Kelvin Hoefler',
      link: 'https://pt.wikipedia.org/wiki/Kelvin_Hoefler',
      descricao: 'Kelvin Hoefler (Itanhaém, 10 de fevereiro de 1994) é um skatista brasileiro, medalhista de prata nas olimpíadas de Tóquio 2020, tendo sido a primeira medalha do país no evento. Também foi bicampeão dos X Games, em Minneapolis e na Noruega.',
      tags:"sls",
    },
    {
      nome: 'Letícia Bufoni',
    ...
    },
    {
      ...
      descricao: 'Augusto Akio, conhecido como Japinha, é um skatista brasileiro de 23 anos que se destacou ao se classificar para a decisão dos Jogos de Paris, aonde tornou-se medalhista Olímpico ao conquistar o merecido 3º lugar, conquisando assim a medalha de bronze. ',
      tags:"bows park japones malabarismo",
    },
    {
      nome: 'Luiz Francisco',
    ...
    },
    {
      ...
      tags:"halfpipe velho pioneiro campeao mundial sk8",
    }
  ];